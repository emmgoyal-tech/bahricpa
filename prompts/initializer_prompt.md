...
- Feature count must match the `feature_count` specified in app_spec.txt (35 features)
- This is a simple brochure/marketing website so the feature count is 35
